            ...
            >
              ...
              {uploadStatus === "idle" && (
                <>
                  ...
                  <div className="mb-2">
                    <span className={`text-xs px-2.5 py-1 rounded-full font-medium ${language === "ta" ? "bg-amber-500/20 text-amber-300 border border-amber-500/40" : "bg-emerald-500/20 text-emerald-300 border border-emerald-500/40"}`}>
                      {language === "ta" ? "தமிழ் பயன்முறை (Tamil OCR + Text Pipeline)" : "English Mode (Standard Ingestion)"}
                    </span>
                  </div>
